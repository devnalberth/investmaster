...
(function ($) {
  ...
  var rtsJs = {
    ...
    swiperActivation: function () {
      ...
      $(document).ready(function () {
        if (document.querySelector(".mySwiper-project-five")) {
      ...
      $(document).ready(function () {
        if (document.querySelector(".mySwiper-blog-one")) {
      ...
      $(document).ready(function () {
        if (document.querySelector(".mySwiperh2_clients")) {
          var swiper = new Swiper(".mySwiperh2_clients", {
            ...
            loop: true,
            pagination: {
              el: ".mySwiperh2_clients .swiper-pagination",
            },
            navigation: {
              nextEl: ".mySwiperh2_clients .swiper-button-next",
              prevEl: ".mySwiperh2_clients .swiper-button-prev",
            },
            autoplay: {
              delay: 3000,
            },
      ...
      $(document).ready(function () {
        if (document.querySelector(".mySwiper-testimoanils-7")) {
          var swiper = new Swiper(".mySwiper-testimoanils-7", {
            ...
            loopFillGroupWithBlank: true,
            pagination: {
              el: '.mySwiper-testimoanils-7 .swiper-pagination',
            },
            navigation: {
              nextEl: ".mySwiper-testimoanils-7 .swiper-button-next",
              prevEl: ".mySwiper-testimoanils-7 .swiper-button-prev",
            },
            autoplay: {
              delay: 3000,
            },
